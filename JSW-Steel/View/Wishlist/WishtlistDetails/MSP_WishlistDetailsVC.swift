...
class MSP_WishlistDetailsVC: BaseViewController, popUpDelegate {
    ...
    @IBOutlet weak var LoaderAnimated: LottieAnimationView!
...
//            }
        ...
        giftLabel.text = "You are eligible to redeem this product."
            ...
            redeemButton.backgroundColor = #colorLiteral(red: 0.9555373788, green: 0.4757598639, blue: 0.1325500607, alpha: 1)
            }
